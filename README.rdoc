...
Rails version 3.2.x or newer. Use WiceGrid 3.0.4 for older Rails 3.0.x and 3.1.x versions.
...
This adds the config file  <tt>config/initializers/wice_grid_config.rb</tt>, the language file
<tt>config/locales/wice_grid.yml</tt>, and the styles file<tt>app/assets/stylesheets/wice_grid.css.scss</tt>
...
You can also use standard Rails Date and DateTime helpers which are a set of dropdown lists.



It's possible to change the style of Date/DateTime filters it in
