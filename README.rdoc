...
WICE_GRID IS UNDER ACTIVE DEVELOPMENT AND API REVISION. THE DOCUMENTATION BELOW CAN BE OUTDATED!
THIS REWRITE TARGETS RAILS 3.2 WITH ITS ASSET PIPELINE.

FOR RAILS 3.0 install version 3.0.4
...
and +active-filter+ if the column's filter is on.
