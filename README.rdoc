...
You are looking at  WiceGrid for Rails 2, version 0.6.0.

For Rails 3.0 see https://github.com/leikind/wice_grid/tree/rails3
...
Likewise, you can add your own HTML after all rows using last_row.
