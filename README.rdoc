...
NO OFFICIAL GEM IS YET RELEASED, SO IF YOU WANT TO TRY IT, CLONE THE REPOSITORY, PUT IT INTO vendor/wice_grid AND ADD THIS TO YOUR GEMFILE:
...
For the Rails 2 version see version 0.6 (https://github.com/leikind/wice_grid/) .
