...
WARNING: Since 3.2.pre2 WiceGrid is not compatible with <tt>will_paginate/tt> because internally it uses <tt>kaminari/tt> for
pagination, and <tt>kaminari/tt> is not compatible with <tt>will_paginate</tt>!
